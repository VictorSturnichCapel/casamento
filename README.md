...
* **Confirmação de presentes da loja:** Formulário integrado que envia `tipo=PresentesConfirmados`, `Nome` e `Item` para o Google Apps Script. Itens com `Cotas` igual a `0` deixam de aparecer.
